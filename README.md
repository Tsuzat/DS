...
You can download the [`ds_setup`](https://github.com/Tsuzat/DS/releases/download/v0.1/ds_setup.exe) (an Installer) or [`ds_portable.zip`](https://github.com/Tsuzat/DS/releases/download/v0.1/ds_portable.zip) (portable zip) file from [releases](https://github.com/Tsuzat/DS/releases).
